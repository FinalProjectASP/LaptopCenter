...
namespace LaptopCenter.Areas.Admin.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewBag.StatusList = new SelectList(Enum.GetValues(typeof(EStatus)));
        ...
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,OrderDate,DeliveryDate,DeleveryLocal,UserId,CustomerName,CustomerPhone,Total,Status")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
